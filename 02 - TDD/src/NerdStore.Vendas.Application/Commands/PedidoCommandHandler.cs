...
namespace NerdStore.Vendas.Application.Commands
{
    public class PedidoCommandHandler : IRequestHandler<AdicionarItemPedidoCommand, bool>
    {
        ...
        {
            if (!VerificaComandoValido(message)) return false;

            var pedido = await _pedidoRepository.ObterPedidoRascunhoPorClientId(message.ClienteId);
        ...
        private bool VerificaComandoValido(Command message)
        {
